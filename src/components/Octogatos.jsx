...
export class Octogatos extends React.Component {
  render() {
    return (
      <div className="container px-4">
          ...
          <img class="d-block width-fit height-auto rounded-1" src="https://octodex.github.com//images/Octogatos.png" alt="Terracottocat" width="400" height="400">
            </img>
            </a>
            <div className="d-flex flex-items-start">
              <span className="pr-1 text-gray">#148:</span>
